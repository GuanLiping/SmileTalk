...
-->
		...
		<div class="head">
			...
			<li>Search</li>
			<li style="width: 170px;"><input type="text" /><img src="/SmileTalk/images/front/sou.jpg" /></li>
			</ul>
			
			<ul class="navi">
				<li onmouseover="changeBG(this)" onmouseout="changeBG2(this)">
					<a class="anavi" href="#">Account</a>
				</li>
				<li onmouseover="changeBG(this)" onmouseout="changeBG2(this)">
					<a class="anavi" href="#">Privacy</a>
				</li>
				<li onmouseover="changeBG(this)" onmouseout="changeBG2(this)">
					<a  class="anavi" href="#">Log out</a>
				</li>
			</ul>
		</div>
