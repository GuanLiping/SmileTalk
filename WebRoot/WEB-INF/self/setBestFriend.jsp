					...
					<tr>
						<td width="80%" valign="top" colspan="2"
							...
							<table width="100%" border="0" cellspacing="5" cellpadding="5">	
								...
								<tr>
									<td class="tblDiv">
                                     <form action="/SmileTalk/friend.do?flag=setBestfriend" method="post">								
										<table width="100%" border="0" cellspacing="3" cellpadding="1">
										<tr>				   										   				
												<td valign="top" width="33%">
													
														<img src="/SmileTalk/images/${friend.user.userId}/head/${friend.user.photo }" width="200px"
															height="150px" border="0" />
												</td>
												<td valign="top">
												 
													 <input type="hidden" name="friendId" value="${friend.user.userId}"/>			 
																							
													<table width="100%" border="0" cellspacing="1"
														cellpadding="1">
														<tr>
															<td>
																<font class="word3">${friend.user.name}</font>
															</td>
														</tr>
													    <tr>
															<td>
																<font class="word3">Description:</font>
															</td>
														</tr>
														 <tr>
															<td>
																<textarea class="wbq" name="description" id="adesc">${friend.description}</textarea>
														...
														<tr>
															<td>
																<input type="submit" class="sub" value="update" style="width: 100px" />
															</td>
														</tr>
													</table>
