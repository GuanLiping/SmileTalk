								...
								<table width="100%" cellspacing="0" cellpadding="5"
									...
									<tr>
										<td style="border-bottom: 1px #D8DFEA solid;">
											<font class="word4"> <a
												href="/SmileTalk/article.do?flag=friendArticleUI&fid=${fid}&oid=xx&pageNo=1&aid=xx"
												...
												<tr>
													<td style="border-bottom: 1px #D8DFEA solid;">
														<table width="100%" border="0" cellspacing="1"
															...
															<tr>
																<td colspan="2">
																	<font class="word4">${articleComment.content} </font>
																</td>
															</tr>
														</table>
													</td>
									...
									<tr>
										<td colspan="2">
										<form action="/SmileTalk/article.do?flag=addArticleComment&bid=${article.articleId}&type=friend" method="post">					
