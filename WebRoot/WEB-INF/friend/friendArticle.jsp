...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br /><jsp:include page="../self/head.jsp"></jsp:include>
								...
								<tr>
									...
									<td rowspan="2" width="10%">
									    ...
									    <img src="/SmileTalk/images/userhead/0000.gif" width="50px" height="50px"/>
				         				...
				         				<c:if test="${friend1.photo!='default.gif'}">
										<img src="/SmileTalk/images/${friend1.userId }/head/${friend1.photo }?abc=<%=Math.random() %>" width="50px" height="50px"/>
									    </c:if>
											...
											<tr>
												...
												<td valign="top">
													<table width="100%" border="0" cellspacing="1"
														...
														<tr>
															<td>
																<a href="article.do?flag=viewFriendOneBlog&bid=${article.articleId}&fid=${friend1.userId}"
